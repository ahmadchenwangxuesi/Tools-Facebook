...
error_reporting(0);
    ...
    $save_dir = "result/result_username.txt";
    $save_dir_name = "result/result_name-username.txt";
    ...
    sleep(3);
    $climate->br()->info('Starting retrieve username your friends..');
    echo "\n";
    progress($progress);
    ...
    $decode = json_decode($ahmadachenwangxuesi);
    $colorstring = getName($n);
